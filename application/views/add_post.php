                        ...
                        <div class="row">
                            <div class="col-5">
                                ...
                                <div class="container" id="profile_picture">
                                    <img src="<?= $img_path ?><?= ((!isset($img)) || ($img == "")) ? "white-image.png" : $img ?>" alt="images" class="picture">
                                </div>
                                <form action="" method="post" enctype="multipart/form-data">
                                    <input type="hidden" name="form-name" value="img">  
                                    <input type="hidden" name="img-data" value="<?= isset($img) ? $img : "" ?>">
                                    <div class="container d-flex justify-content-center">
                            ...
                            <div class="col" id="data_profile">
                                ...
                                <form action="" method="post">
                                    ...
                                    <input type="hidden" name="image-data" value="<?= isset($img) ? $img : "" ?>">
                                    <table>
                                        <th>
                                            <h3>New Post</h3>
                                        </th>
